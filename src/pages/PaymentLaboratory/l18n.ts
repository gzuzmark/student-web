const paymentLaboratoryL18n = {
	'payment.left.prefix': '¡YA CASI ESTAMOS!',
	'payment.left.title': 'Realiza el pago del laboratorio',
	'payment.left.appointmentTitle': 'DATOS DEL LABORATORIO',
...
export default paymentLaboratoryL18n;
