const paymentL18n = {
	'payment.left.prefix': '¡YA CASI ESTAMOS!',
	'payment.left.title': 'Realiza el pago de tu consulta',
	...
	'payment.right.title.steps': 'COMPRA FÁCIL Y 100% SEGURO',
	'payment.right.description.steps': '* PAGAR EN EFECTIVO o transferencia, es fácil:',
	'payment.right.steps.one': 'Completa el fomulario.',
	'payment.right.steps.two': 'Por correo te llegará un PIN (Código de Pago) y un PDF, descárgalo.',
